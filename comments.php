...
<div id="comments" class="cf">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
        ...
        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
            ...
            <?php endif; ?> 
            <textarea name="text" id="textarea" class="form-control" onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('misubmit').click();return false};" placeholder="<?php _e('期待你的评论...'); ?>" required ><?php $this->remember('text',false); ?></textarea>
